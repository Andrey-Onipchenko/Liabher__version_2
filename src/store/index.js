    ...
    products: [
      {
        ...
        description: [
          ...
          {
            text: "<span class='blue'>В холодильнику Liebherr з технологією PowerCooling: рівномірне охолодження</span>",
          },
          {
          ...
          {
            text: "<span class='blue'>Додаткову надійність зберігання забезпечує технологія віддаленого управління SmartDevice. Вона дозволяє активовувати функцію SupeCool за допомогою смартфона.</span> Уявіть, ви купуєте свіжі продукти в магазині, а холодильник за вашою командою вже готується швидко їх охолодити. ",
          },
          {
            text: "Оптимальні умови для тривалого збереження продуктів такого роду – холодильник Liebherr з технологією PowerCooling.",
          },
          {
            text: "<span class='blue'>Функція швидкої заморозки SuperFrost</span>",
          },
        ],
      },
      {
        ...
        description: [
          ...
          {
            text: "<span class='blue'>В холодильнику Liebherr з вентилятором PowerCooling та повітряним фільтром FreshAir:  оптимальне збереження</span>",
            normal: true,
          },
          {
          ...
          {
            text: "<span class='blue'>Лимони можуть залишатися в холодильнику при температурі 7°С протягом місяця.</span>",
          },
          {
      ...
      },
      {
        ...
        description: [
          {
            text: "<span class='blue'>В звичайному холодильнику: 2 дні</span>",
            normal: true,
          },
          {
            text: "<span class='blue'>В холодильнику Liebherr з зоною свіжості BioFresh: 6 днів</span>",
            normal: true,
          },
          {
          ...
          {
            text: "<span class='blue'>Відразу після відкриття треба перекласти ікру в іншу ємність</span>. Ідеально підійде скляна баночка з герметичною кришкою. Для цього можна використовувати і пластиковий контейнер, але слід переконатися, що він не має запаху.",
          },
          {
            text: "В жодному разі не можна багаторазово заморожувати і розморожувати ікру - продукт стає небезпечним для вживання.",
          },
          {
            text: "Оптимальні умови для тривалого збереження червоної ікри – холодильник Liebherr,<span class='blue'> зона BioFresh, контейнер Meat & DairySafe.</span> ",
          },
        ],
      },
      {
        ...
        description: [
          {
            text: "<span class='blue'>В звичайному холодильнику: 3 дні</span>",
            normal: true,
          },
          {
            text: "<span class='blue'>В холодильнику Liebherr з зоною свіжості BioFresh: 12 днів</span>",
            normal: true,
          },
          {
          ...
          {
            text: "<span class='blue'>Дверцята звичайного холодильника </span>- це не краще місце для зберігання молока: продукт вимагає нижчої температури. ",
          },
          {
            text: "Оптимальні умови для тривалого збереження молока – холодильник Liebherr,<span class='blue'> зона BioFresh, контейнер Meat & DairySafe.</span> ",
          },
        ],
      },
      {
        ...
        description: [
          {
            text: "<span class='blue'>В звичайному холодильнику: 15 днів</span>",
            normal: true,
          },
          {
          ...
          {
            text: "<span class='blue'>Краще зберігати яйця вістрями донизу.</span>",
          },
          {
            text: "оді жовток буде знаходитися в центрі і не торкатиметься повітряного шару, що розташований у тупого кінця. ",
          },
          {
            text: "Яйця з тріснутою шкаралупою краще використовувати відразу або заморозити.",
          },
          {
            text: "Оптимальні умови для тривалого зберігання яєць – холодильник Liebherr,<span class='blue'> зона BioFresh, контейнер Meat & DairySafe.</span> ",
          },
        ],
      },
      {
        ...
        description: [
          ...
          {
            text: "<span class='blue'>В холодильнику Liebherr з режимом SuperCool: ідеальне охолодження</span>",
            normal: true,
          },
          {
          ...
          {
            text: "<span class='blue'>Смак і консистенція страв зберігаються.</span>",
          },
          {
      ...
      },
      {
        ...
        description: [
          ...
          {
            text: "<span class='blue'>В холодильнику Liebherr з режимом SuperCool: швидке охолодження і комфортне зберігання</span>",
            normal: true,
          },
          {
          ...
          {
            text: "<span class='blue'>Заздалегідь активуйте режим SuperCool в холодильнику Liebherr, він допоможе зберегти температуру всередині холодильника на заданому рівні.</span>",
          },
          {
            text: "Оптимальні умови для тривалого збереження готових борщу– холодильник Liebherr з режимом SuperCool <span class='blue'>Технологія PowerCooling</span>",
          },
        ],
      },
      {
        ...
        description: [
          ...
          {
            text: "<span class='blue'>Термін зберігання можна продовжити, відокремивши м'ясо від кістки</span> – так воно може зберігатися на день-два довше.",
          },
          {
          ...
          {
            text: "Оптимальні умови для тривалого збереження м'яса – холодильник Liebherr, <span class='blue'>зона BioFresh, контейнер Meat & DairySafe.</span>",
          },
        ],
      },
      {
        ...
        description: [
          ...
          {
            text: "<span class='blue'>В холодильнику Liebherr з зоною свіжості BioFresh: 7 днів</span>",
            normal: true,
          },
          {
          ...
          {
            text: "Оптимальні умови для тривалого збереження грибів – холодильник Liebherr, <span class='blue'>зона BioFresh, контейнер Fruit & VegetableSafe.</span> ",
          },
        ],
      },
      {
        ...
        description: [
          {
            text: "<span class='blue'>В звичайному холодильнику: 6 днів</span>",
            normal: true,
          },
          {
            text: "<span class='blue'>В холодильнику Liebherr з зоною свіжості BioFresh: 18 днів</span>",
            normal: true,
          },
          {
          ...
          {
            text: "Оптимальні умови для тривалого збереження буряку – холодильник Liebherr, <span class='blue'>зона BioFresh, контейнер Fruit & VegetableSafe.</span> ",
          },
        ],
      },
      {
        ...
        description: [
          {
            text: "<span class='blue'>В звичайному холодильнику: 50 днів</span>",
            normal: true,
          },
          {
            text: "<span class='blue'>В холодильнику Liebherr з зоною свіжості BioFresh: 80 днів</span>",
            normal: true,
          },
          ...
          {
            text: "Оптимальні умови для тривалого збереження моркви – холодильник Liebherr, <span class='blue'>зона BioFresh, контейнер Fruit & VegetableSafe.</span>",
          },
        ],
      },
      {
        ...
        description: [
          {
            text: "<span class='blue'>В звичайному холодильнику: 40 днів</span>",
            normal: true,
          },
          {
            text: "<span class='blue'>В холодильнику Liebherr з зоною свіжості BioFresh: 80 днів</span>",
          ...
          {
            text: "Оптимальні умови для тривалого збереження яблук – холодильник Liebherr, <span class='blue'>зона BioFresh, контейнер Fruit & VegetableSafe.</span> ",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        description: [
          ...
          {
            text: "<span class='blue'>В холодильнику Liebherr з режимом SuperFrost: глибока і рівномірна заморозка</span>",
          },
          {
          ...
          {
            text: "Глибока та швидка заморозка позбавляє від таких неприємностей як крижана кірка на плодах, примерзання до стінок та полиць. <span class='blue'>Продукти не втрачають властивих їм смакових і поживних якостей.</span> ",
          },
          {
          ...
          {
            text: "<span class='blue'>Корисний гаджет 1</span>: акумулятори холоду. Дозволяють зберегти необхідну температуру в морозильній камері при короткочасному відключенні електроживлення.",
          },
          {
            text: "<span class='blue'>Корисний гаджет 2</span>: піднос. З ним можна зручно розподілити продукти без ризику примерзання один до одного, отже їхня первинна форма буде збережена. ",
          },
          {
            text: "<span class='blue'>Незалежні контури охолодження DuoCooling</span>",
          },
        ],
      },
    ],
