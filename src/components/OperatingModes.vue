    ...
    return {
      slides: [
        ...
        },
        {
          ...
          description: [
            "Відсік в холодильнику  де застосована технологія HydroBreeze - подавання холодного туману кожні 90 хвилин. Холодний туман, що покриває розміщені у відсіку фрукти та овочі, забезпечує хрусткість и свіжість, а також покращує структуру продуктів.",
